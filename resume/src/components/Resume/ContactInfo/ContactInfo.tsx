    ...
    <div className="shadow rounded-xl overflow-hidden">
      ...
      <div className="pt-14 p-7 bg-white relative">
        ...
        <div className="flex flex-col space-y-2">
          <a href="https://media.licdn.com/dms/document/C562DAQGtz7ByScYKbQ/profile-treasury-document-pdf-analyzed/0/1672932331978?e=1674086400&v=beta&t=_iZp12zKkm3nzThhsESJza58x_wkOO08w2P49hQjyZY" target="_blank" rel="noopener noreferrer" download>
            <div className="flex">
          ...
          <div className="flex">
            {rootElement ?
              <>
                ...
                <button className="download-btn-icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
